...
int main()
{
	...
	int i,j;
	cout<<"\n\n\n\n\n\n\n\n\n\n\n \t\t\t|============ WELCOME TO SUBWAY STORE MANAGEMENT ============|";
	getch();
	system("cls");
	cout<<"\n\t\t   SUBWAY  STORE MANAGEMENT SYSTEM\n";	
	cout<<"=============================================================";
	cout<<"\n\n\t\t   1. Dealer Menu\n\n\t\t   2. Customer Menu\n\n\t\t   3. Employee Menu";
	cout<<"\n\n=============================================================\n";
	cout<<"\n\nEnter Your Choice:";
...

{
	...
	if(strcmp(pass2,"projectnotes")==0)
	{
	empmenu:
	system("cls");
	cout<<"=================================================================";
